...
<p align="center">
A Frontend monorepo housing all Raziora client-side applications, from products to internal tools. Centralizes shared components and libraries to maintain consistency across the organization's frontend ecosystem
</p>
