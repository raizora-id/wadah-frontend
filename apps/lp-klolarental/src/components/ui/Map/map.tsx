    ...
    return (
        <section
            ...
            <p className='mt-4 max-w-2xl text-center text-base text-balance text-gray-400 sm:mt-8 sm:text-xl'>
                Complete oversight of your farming operations across fields, irrigation systems, and aerial monitoring,
                delivering insights even in remote rural locations.
            </p>
                ...
                <div className='absolute -top-3 left-[130px]'>
                    <div className='relative flex items-center justify-center'>
                        ...
                        <div
                            ...
                            className='absolute size-10 animate-[ping_5s_ease_infinite] rounded-full ring-1 ring-orange-500/50'></div>
                    </div>
                </div>
