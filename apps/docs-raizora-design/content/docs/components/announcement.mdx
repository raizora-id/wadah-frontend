...
import {
  ...
  AnnouncementTag,
  AnnouncementTitle,
} from '@packages/ui/components/base/announcement';
...
<AutoTypeTable path="node_modules/@packages/ui/src/components/base/announcement/index.tsx" name="AnnouncementProps" />

### AnnouncementTag

The `AnnouncementTag` component is used to display the prefix of the announcement.

<AutoTypeTable path="node_modules/@packages/ui/src/components/base/announcement/index.tsx" name="AnnouncementTagProps" />

### AnnouncementTitle

The `AnnouncementTitle` component is used to display the title of the announcement.

<AutoTypeTable path="node_modules/@packages/ui/src/components/base/announcement/index.tsx" name="AnnouncementTitleProps" />
