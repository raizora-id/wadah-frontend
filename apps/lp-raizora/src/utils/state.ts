...
export const pageAtom = atom<PageAtom>(process.env.NODE_ENV == 'development' ? 'HOME' : 'POWER');
...
function useState<TName extends string, TType>(name: TName, atom: PrimitiveAtom<TType>) {
    return () => {
        type State = {
