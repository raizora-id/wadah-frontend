...
export async function generateMetadata({ params }: CarDetailsPageProps): Promise<Metadata> {
    ...
    const car = await getCarById(String(id));
...
//TODO(@ridhoassuryadi): need fix after initiate deployment
...
//     const [carInteriorDataUrl, carDoorPanelDataUrl, carSeatDataUrl] = await Promise.all([
...
//             style={
//                 {
//                     '--reserve-card-top-offset': 'calc(var(--site-header-height) + var(--content-padding-y)'
//                 } as React.CSSProperties
//             }>
//             <div className='mx-auto w-full max-w-none p-0 md:max-w-[90%] xl:max-w-6xl'>
//                 <div className='hidden md:block md:pt-8'>
//                     <h1 className='text-2xl font-semibold text-balance'>{car.name}</h1>
//                 </div>
...
//                             <div className='flex flex-wrap items-center gap-1 text-[13px] text-neutral-800 capitalize lg:text-[15px]'>
...
//                                     <span className='text-xl'>·</span>
//                                     {car.review_count > 0 && (
//                                         <span className='text-neutral-800'>{car.review_count} reviews</span>
//                                     )}
//                                 </div>
//                             </div>
...
//                                             A car equipped with a GPS navigation system to help you find your way with
//                                             ease.
//                                         </p>
//                                     </div>
//                                 </div>
...
//                                         <p className='mt-0.5 text-[14px] leading-5 text-neutral-600'>
//                                             Access to round-the-clock roadside support for any emergencies or
//                                             breakdowns.
//                                         </p>
//                                     </div>
//                                 </div>
...
//                                         <p className='mt-0.5 text-[14px] leading-5 text-neutral-600'>
//                                             Enjoy complimentary Wi-Fi access during your drive to stay connected on the
//                                             go.
//                                         </p>
//                                     </div>
//                                 </div>
...
//                                         <p className='mt-0.5 text-[14px] leading-5 text-neutral-600'>
//                                             Optional child safety seats are available to ensure the safety of your
//                                             little ones.
//                                         </p>
//                                     </div>
//                                 </div>
...
//                             <h2 className='text-lg font-semibold lg:text-xl'>What this car offers</h2>
//                             <div className='pt-8'>
