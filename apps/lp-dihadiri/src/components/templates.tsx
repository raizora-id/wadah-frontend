...
const templatesByCategory: CategoryTemplates = {
  ...
  'Cards': [
    { id: 21, src: '/placeholder.svg?height=400&width=400', alt: 'Card Template 1' },
    { id: 22, src: '/placeholder.svg?height=400&width=400', alt: 'Card Template 2' },
    { id: 23, src: '/placeholder.svg?height=400&width=400', alt: 'Card Template 3' },
  ],
  'Mugs': [
    { id: 24, src: '/placeholder.svg?height=400&width=400', alt: 'Mug Template 1' },
    { id: 25, src: '/placeholder.svg?height=400&width=400', alt: 'Mug Template 2' },
    { id: 26, src: '/placeholder.svg?height=400&width=400', alt: 'Mug Template 3' },
  ],
}
  ...
  return (
    <section className="px-4 py-20">
      <div className="mx-auto max-w-[1200px]">
        <h2 className="text-[40px] font-bold leading-tight tracking-tight text-black">
          Professional-Grade Templates.
          <br />
          Every Design Need, Covered.
        </h2>
