            ...
            <div className='grid grid-cols-1 gap-12 md:grid-cols-4 md:gap-0'>
                ...
                <div className='col-span-2 my-auto px-2'>
                    ...
                    <p className='mt-4 text-balance text-gray-700'>
                        Deploy intelligent monitoring and automated response systems across your fields, irrigation
                        networks, and aerial operations with our integrated platform.
                    </p>
                </div>
                                ...
                                orbitingObjects={[
                                    <div key='obj1' className='relative flex items-center justify-center'>
                                        ...
                                        <div
                                            ...
                                            className='absolute size-10 animate-[ping_7s_ease_infinite] rounded-full ring-1 ring-orange-500/50'></div>
                                    </div>,
                ...
                <div className='col-span-2 my-auto px-2'>
                    ...
                    <p className='mt-4 text-balance text-gray-700'>
                        Revolutionize your farming operation with edge-computing AI that transforms raw field data into
                        actionable insights in real-time. Make informed decisions faster, reduce resource waste, and
                        maximize yields.
                    </p>
                </div>
                <div className='relative col-span-2 flex items-center justify-center overflow-hidden'>
                ...
                <div className='col-span-2 my-auto px-2'>
                    ...
                    <p className='mt-4 text-balance text-gray-700'>
                        Add new sensors and capabilities to your farm network with zero setup required. Our systems
                        automatically connect and coordinate with each other.
                    </p>
                </div>
                <div className='relative col-span-2 flex items-center justify-center overflow-hidden'>
                    <svg
