...
import AppSidebar from '@packages/ui/components/layouts/sidebars/app-sidebar/app';
import { MenuItemComponent } from '@packages/ui/components/layouts/sidebars/menu-item';
import DropdownHeaderContent from '@packages/ui/components/layouts/sidebars/nav/dropdown-header-content';
import HeaderSidebar from '@packages/ui/components/layouts/sidebars/nav/header-sidebar';
