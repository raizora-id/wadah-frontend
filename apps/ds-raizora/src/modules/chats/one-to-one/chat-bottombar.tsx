...
import { Button, buttonVariants } from "@packages/ui/components/base/button";
import { cn } from "@/lib/utils";
import { AnimatePresence, motion } from "framer-motion";
import { loggedInUserData, Message } from "./../../../data/chat";

import {
    Popover,
    PopoverContent,
    PopoverTrigger,
} from "@packages/ui/components/base/popover";

import { ChatInput } from "@packages/ui/components/ui/chat/chat-input";
...
export default function ChatBottombar({ isMobile }: ChatBottombarProps) {
    ...
    const hasInitialResponse = useChatStore((state) =>
