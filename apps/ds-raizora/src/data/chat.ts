import { MessageChat } from "@/shared/types/chat";
...
export const messages: MessageChat[] = [
    { id: 1, sender: "Alice", content: "Halo, apa kabar?", time: "10:00 AM", type: "text", isMe: false },
    { id: 2, sender: "Me", content: "Baik, kamu?", time: "10:02 AM", type: "text", isMe: true },
    { id: 3, sender: "Alice", content: "Ini file penting", time: "10:05 AM", type: "file", fileSize: "2MB", isMe: false },
    { id: 4, content: "Notifikasi: Anda bergabung dengan grup", time: "10:10 AM", type: "text", isMe: null } // Notifikasi tetap memiliki 'type'
];
