...
const OrganizationSchema = z.object({ id: z.number(), name: z.string(), phone: z.number(), nib: z.string(), npwp: z.string(), address: z.string(), email: z.string().email(), image: z.string() }).partial().passthrough();
const CreateOrganizationRequestSchema = z.object({ name: z.string(), phone: z.number(), nib: z.string(), npwp: z.string(), address: z.string(), email: z.string().email(), image: z.string() }).partial().passthrough();
