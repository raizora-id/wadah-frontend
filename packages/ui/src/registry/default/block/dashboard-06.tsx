        ...
        <div className='bg-muted/40 flex min-h-screen w-full flex-col'>
            <aside className='bg-background fixed inset-y-0 left-0 z-10 hidden w-14 flex-col border-r sm:flex'>
                <nav className='flex flex-col items-center gap-4 px-2 sm:py-5'>
                    <Link
                        href='#'
                        className='group bg-primary text-primary-foreground flex size-9 shrink-0 items-center justify-center gap-2 rounded-full text-lg font-semibold md:size-8 md:text-base'>
                    ...
                    <Sheet>
                        ...
                        <SheetContent side='left' className='sm:max-w-xs'>
                            <nav className='grid gap-6 text-lg font-medium'>
                                <Link
                                    href='#'
                                    className='group bg-primary text-primary-foreground flex size-10 shrink-0 items-center justify-center gap-2 rounded-full text-lg font-semibold md:text-base'>
